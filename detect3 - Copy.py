...
th = 5
th1 = 4           # always the multiple of th and th1 should be 20 approx. fps
ROOT = 'C:/Users/User/Desktop/yolov5'
source_path = 'C:/Users/User/Desktop/New folder/Pillar No A3 (E).mp4'
dest_path = 'C:/Users/User/Desktop/New folder/'
...
def run(
        weights=ROOT / 'runs/train/exp_150epoch_91/weights/best.pt',  # model path or triton URL
        source= source_path ,  # file/dir/URL/glob/screen/0(webcam)
        data=ROOT / 'data/NASSCO_Sewer_dataset.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp_150epoch_91/weights/best.pt', help='model path or triton URL')
    parser.add_argument('--source', type=str, default= source_path , help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'data/NASSCO_Sewer_dataset.yaml', help='(optional) dataset.yaml path')
