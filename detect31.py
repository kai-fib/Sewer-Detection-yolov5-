...
source_path = 'C:/Users/moumi/OneDrive/Desktop/demo/20250301_141434.mp4'
dest_path = 'C:/Users/moumi/OneDrive/Desktop/demo/'
###
...
# stage2_water_weights ; Wrc_sewer_stage1.yaml
# Europe_dataset_13_rem_fou(90) ;Europe_stage2.yaml
#Europe_dataset_17_slu_gra_comb_root(91.5) ; wrc_stage3.yaml
#E:\P1_YOLO\yolov5\runs\train\exp6; 
@smart_inference_mode()
def run(
        weights=ROOT / 'runs/train/Europe_dataset_15_fr_cr(88.9)/weights/best.pt',  # model path or triton URL
        source= source_path ,  # file/dir/URL/glob/screen/0(webcam)
        data=ROOT / 'data/Europe_stage2.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/Europe_dataset_15_fr_cr(88.9)/weights/best.pt', help='model path or triton URL')
    parser.add_argument('--source', type=str, default= source_path , help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'data/Europe_stage2.yaml', help='(optional) dataset.yaml path')
...
#ffmpeg -i Halol_raw.mp4 -vcodec libx264 -acodec -aac -strict experimental Halol_raw_c.mp4

#ffmpeg -i "C:\Users\Kaif Ibrahim\Desktop\solinas_downloads\Video_dataset\deform.mp4" -vcodec libx264 -acodec -aac -strict experimental "C:\Users\Kaif Ibrahim\Desktop\solinas_downloads\Video_dataset\deform_c.mp4"
